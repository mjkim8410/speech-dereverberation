...
def build_model(CONTINUE_FROM_CHECKPOINT):
    ...
    if CONTINUE_FROM_CHECKPOINT:
        checkpoint_path = "../../checkpoints_v1/v1_model_epoch_"+str(ITER)+".pth"  # CHANGE to your checkpoint
...
def train_one_epoch(model, optimizer, epoch):
    ...
    checkpoint_path = os.path.join("../../checkpoints_v1", f"v1_model_epoch_{epoch+ITER+1}.pth")
    torch.save({
        "epoch": epoch+ITER+1,
